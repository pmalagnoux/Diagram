...
import webService.metier.tag.Tag;
...
public class RecipeManager {
	...
	public List<Recipe> getRecipes(@WebParam(name="maxDifficulty")int maxDifficulty, @WebParam(name="recipeType")int recipeType, @WebParam(name="maxCookingTime")int maxCookingTime){

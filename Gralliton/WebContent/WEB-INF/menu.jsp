...
<nav class="navbar navbar-expand-lg navbar-white bg-manavbar" style= "background-color: #343434" >
	...
	<a class="navbar-brand" href="accueil" style= "color : #ffffff;"> 
		<img src="images/cat.png" class="d-inline-block align-top" width="30" height="30" alt="">
		Grailliton
	</a>
	<!-- Formulaire de recherche (bouton + barre de recherche) -->
    ...
    <button class="mr-3 btn btn-primary" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" style= "background-color: #C7C7C7" aria-expanded="false" aria-label="Toggle navigation">Recherche avancée</button>
  	...
  	<c:choose>
		<c:when test="${empty sessionScope.userLogin }"><!-- Interface visiteur -->
		...
		<c:otherwise> <!-- Dropdown (Interface membre)-->
			<div class="nav-item dropdown">
				<a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style= "color : #C7C7C7;">Mon Compte</a>
...
<!-- Contenu caché pour recherche avancée -->
